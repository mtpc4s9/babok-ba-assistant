...
| [techniques.md](techniques.md) | Technique selection (e.g., Backlog Management, Decision Analysis). | Load only if the user asks HOW to perform a task. |
| [gotchas.md](gotchas.md) | CBAP exam traps and common life cycle anti-patterns. | Load only if the user asks about risks, pitfalls, or exam prep. |
